...
centered_data_scaled <- centered_data %>%
  mutate(pct_pop_changeE = pct_pop_changeE * 100,
         pct_black_pop_2011E_100 = pct_black_pop_2011E * 100,
         pct_white_pop_2011E_100 = pct_white_pop_2011E * 100,
        pct_asian_pop_2011E_100 =  pct_asian_pop_2011E * 100,
         pct_hispanic_pop_2011E_100 = pct_hispanic_pop_2011E * 100,
        pct_renter_2011E_100 = pct_renter_2011E * 100,
...
centered_model_scaled <- lm(pct_pop_changeE ~ pct_black_pop_2011E_100 + pct_white_pop_2011E_100 + pct_asian_pop_2011E_100 + pct_hispanic_pop_2011E_100 +  pct_renter_2011E_100 + log2_med_income_2011E +  log2_med_propvalue_2011E, centered_data_scaled)

coeff_names_scaled <- c("Constant" = "(Intercept)",
                 "% Black" = "pct_black_pop_2011E_100",
                 "% White" = "pct_white_pop_2011E_100",
                 "% Asian" = "pct_asian_pop_2011E_100",
                 "% Hispanic" = "pct_hispanic_pop_2011E_100",
                 "% Renter" = "pct_renter_2011E_100",
