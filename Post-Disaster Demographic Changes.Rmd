...
The correlation tests tell us that there is a significant relationship between percent population change and: percent white, percent Asian, percent renter, and median income. There is not a significant relationship between percent population change and: percent Black, percent Hispanic, and median property value.
...
```
There is a significant relationship between percent population change and majority vote.
...
```{r multivariate regression continuous, message=FALSE}

full_model_cont <- lm(pct_pop_changeE ~ pct_black_pop_2011E + pct_white_pop_2011E + pct_asian_pop_2011E + pct_hispanic_pop_2011E + pct_renter_2011E + med_income_2011E + med_propvalue_2011E, full_acs)

summary(full_model_cont)

```
```{r multivariate regression categorical, message=FALSE}

full_model_cat <- lm(pct_pop_changeE ~ majority_vote + flooded, full_acs)

summary(full_model_cat)
