...
#pop_density_2011_quartiles <- quantile(full_acs$pop_density_2011E, na.rm = TRUE)
```
...
#pop_density_2011_st_dev <- sd(full_acs$pop_density_2011E, na.rm = TRUE)
```
...
#pop_density_2011_hist <- ggplot(full_acs) +
  #geom_histogram(aes(x = pop_density_2011E),
                 #bins = 30)
